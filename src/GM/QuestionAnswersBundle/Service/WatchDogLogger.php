...
use GM\QuestionAnswersBundle\Entity\WatchDogLogger as WatchDogLoggerEntity;
...
class WatchDogLogger
{
    ...
    public function __construct(RequestStack $requestStack, EntityManager $em, TokenStorage $tokenStorage, AuthorizationChecker $authorizationChecker, MessageGenerator $msgGenerator){
